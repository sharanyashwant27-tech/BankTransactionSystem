...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        seedUser(adminUsername, adminPassword, adminEmail, 15000.00, List.of(
        ...
        seedUser("admin1", defaultPassword, "admin1@bank.com", 8000.00, List.of(
        ...
        seedUser("admin2", defaultPassword, "admin2@bank.com", 6000.00, List.of(
        ...
        seedUser("admin3", defaultPassword, "admin3@bank.com", 7000.00, List.of(
        ...
        seedUser("admin4", defaultPassword, "admin4@bank.com", 12000.00, List.of(
        ...
        seedUser("admin5", defaultPassword, "admin5@bank.com", 9000.00, List.of(
